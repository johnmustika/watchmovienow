...
export async function generateMetadata({ params }) {
  ...
  const pageUrl = `https://watchnowmovie.netlify.app/movie/genre/${genreName}`;
  const imageUrl = 'https://live.staticflickr.com/65535/55084415924_d4029dae39_b.jpg';

  return {
    title: `WatchNow - ${title} Movies`,
    description: `Find and watch the best ${title} movies for free on WatchNow.`,
    openGraph: {
      title: `WatchNow - ${title} Movies`,
      description: `Find and watch the best ${title} movies for free on WatchNow.`,
      url: pageUrl,
