  ...
  const schemaMarkup = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "primaryImageOfPage": {
          "@type": "ImageObject",
          "url": "https://live.staticflickr.com/65535/55084415924_d4029dae39_b.jpg",
          "width": 1200,
          "height": 630
        },
      ...
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "How often is trending content updated on WatchNow?",
            "acceptedAnswer": {
              "@type": "Answer",
          ...
          {
            "@type": "Question",
            "name": "Can I find where to stream movies for free on WatchNow?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes! WatchNow provides information on both free streaming options (ad-supported platforms) and premium subscription services, helping you find the most cost-effective way to watch your favorite content."
            }
          },
          {
            "@type": "Question",
            "name": "Does WatchNow cover international movies and TV shows?",
            "acceptedAnswer": {
              "@type": "Answer",
          ...
          {
            "@type": "Question",
            "name": "How does WatchNow determine what's trending?",
            "acceptedAnswer": {
              "@type": "Answer",
      ...
      <div className="container mx-auto px-4 py-8">
            ...
            <div className="bg-slate-900/50 p-6 rounded-lg mt-8">
              ...
              <div className="space-y-4">
                <div className="faq-item" itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                  <h4 className="font-semibold text-blue-300 mb-2" itemProp="name">How often is trending content updated on WatchNow?</h4>
                ...
                <div className="faq-item" itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                  <h4 className="font-semibold text-blue-300 mb-2" itemProp="name">Can I find where to stream movies for free on WatchNow?</h4>
                  <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                    <p className="text-gray-300" itemProp="text">
                      Yes! WatchNow provides information on both free streaming options (ad-supported platforms) and premium subscription services, helping you find the most cost-effective way to watch your favorite content.
                    </p>
                  </div>
                </div>
                
                <div className="faq-item" itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                  <h4 className="font-semibold text-blue-300 mb-2" itemProp="name">Does WatchNow cover international movies and TV shows?</h4>
                  <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                    <p className="text-gray-300" itemProp="text">
                ...
                <div className="faq-item" itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                  <h4 className="font-semibold text-blue-300 mb-2" itemProp="name">How does WatchNow determine what's trending?</h4>
                  <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                    <p className="text-gray-300" itemProp="text">
        ...
        <section className="text-center py-12 bg-gradient-to-r from-purple-900/30 to-blue-900/30 rounded-2xl border border-slate-700">
          ...
          <p className="mt-8 text-gray-400 max-w-3xl mx-auto text-xs md:text-sm">
            WatchNow • Trending Movies & TV Shows • Daily Updates • Streaming Availability • Netflix • Disney+ • Prime Video • Hulu • HBO Max • Free Streaming • HD Quality • What to Watch • Best Movies 2024 • Popular TV Series • Entertainment Guide • Movie Recommendations • Binge-Watch Series • New Releases • Top Rated Shows
          </p>
        </section>
      </div>
    </div>
...
export const metadata = {
  title: 'WatchNow | Trending Movies & TV Shows to Stream Today - Daily Updates',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'WatchNow - Trending Movies & TV Series to Stream Today',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'WatchNow | Trending Movies & TV Shows to Stream Today',
    description: 'Discover what\'s trending today across all streaming platforms on WatchNow.',
