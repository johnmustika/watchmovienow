...
export const metadata = {
  ...
  description: 'Find where to watch movies & TV series online for free or on Netflix, Disney+, Prime Video. WatchNow tracks 10,000+ movies, 5,000+ shows, box office results, actor info, and provides HD streaming guides across all genres (action, horror, romance, anime, drakor).',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'WatchNow - Watch Movies Online Free and Stream TV Series',
      },
    ],
    locale: 'en_US',
    type: 'website',
